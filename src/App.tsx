...
const DB_NAME = "most-vite-db-v15";
const DB_VERSION = 2;
...
const drawOrderPdfPage = (doc: any, pdfOrder: Order) => {
    ...
    doc.setFont("helvetica", "normal");
    doc.setFontSize(8);
    doc.text("Name/ Unterschrift des Auftraggebers", 92, 243.2, { align: "center" });
    if (pdfOrder.signatureDataUrl) {
      try {
        doc.addImage(pdfOrder.signatureDataUrl, "PNG", 97, 230.5, 38, 9.5);
      } catch {}
    }
