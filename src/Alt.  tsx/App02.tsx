    ...
    <div className="app-shell">
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .dropdown-list{margin-top:8px;border:1px solid var(--line);border-radius:14px;max-height:240px;overflow:auto;background:#fff;position:relative;z-index:4}.field-group{border:1px solid var(--line);border-radius:16px;padding:12px;background:#f8fafc}.field-group-title{font-size:12px;font-weight:800;letter-spacing:.04em;color:#475569;text-transform:uppercase;margin-bottom:10px}
        .icon-btn{border:1px solid var(--line);background:#fff;border-radius:12px;padding:6px 8px;cursor:pointer}
        .metric{background:linear-gradient(180deg,#f8fafc 0%,#eff6ff 100%);border-radius:16px;padding:12px;display:grid;gap:6px}
        ...
        .info-list{display:grid;gap:8px}.totals-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;margin-top:16px}.stats-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-top:12px}.stat-card{border:1px solid var(--line);border-radius:16px;padding:12px;background:#fff}.stat-card span{display:block;color:var(--muted);font-size:12px;margin-bottom:4px}.stat-card strong{font-size:22px}
      ...
      {tab === "auftrag" && (
        <div className="grid-2">
          <section className="panel">
            ...
            <div className="checks" style={{ position: "relative", zIndex: 1 }}>
            ...
            <div className="grid-2">
              <div className="box">
                ...
                <div className="field-group"><div className="field-group-title">Nummern</div><div className="form-grid two"><label><span>Kundennummer</span><input value={order.customerNo} onChange={(e) => updateOrder("customerNo", e.target.value)} /></label><label><span>Kundenbestellnr.</span><input value={order.customerOrderNo} onChange={(e) => updateOrder("customerOrderNo", e.target.value)} /></label></div></div>
          ...
          <aside className="side-stack">
            <section className="panel compact">
              ...
              <button className="btn secondary" onClick={() => setSettingsOpen(true)}>Einrichtung</button>
            </section>
