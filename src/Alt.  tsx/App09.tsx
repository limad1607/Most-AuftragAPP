...
export default function App() {
  ...
  const exportDailyReport = async () => {
    ...
    const drawSummaryTable = (
      ...
      const w = 86;
      const h = 46;
      const titleBottom = y0 + 7;
      const headBottom = y0 + 16.75;
      const col1 = x0 + 8;
      const col2 = x0 + 19;
      const col3 = x0 + 33;
      const col4 = x0 + 47;
      ...
      doc.setFont("helvetica", "normal");
      doc.setFontSize(7);
      doc.text(title, x0 + w / 2, y0 + 4.9, { align: "center" });
      doc.text("Art", x0 + 2.5, y0 + 13.0);
      doc.text("Total", x0 + 26.0, y0 + 13.0, { align: "center" });
      doc.text("Summe", x0 + 74.0, y0 + 13.0, { align: "center" });
